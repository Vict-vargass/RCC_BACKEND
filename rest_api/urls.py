...
router.register(r'servicios', viewset_pyme.ServicioViewSet)
...
router.register(r'redpoints-ahorro', views.RPAhorroViewSet)
router.register(r'correos', views.Correos, basename='correos')
