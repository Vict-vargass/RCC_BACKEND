"""
Django settings for redcc_backend project.
...
SECRET_KEY = 'django-insecure-)h14_#cp^^usd1ecgx6bxv-wf==@rg@ixeevj)d#%*uaur=nv1'
...
AUTH_USER_MODEL = 'rest_api.Administrador'
